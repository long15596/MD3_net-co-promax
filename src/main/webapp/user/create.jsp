...
<form method="post">
    ...
    <div class="input-group flex-nowrap" style="width: 400px; margin-bottom: 10px">
        ...
        <input type="number" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping" name="username">
    </div>
    <div class="input-group flex-nowrap" style="width: 400px; margin-bottom: 10px">
        <div class="input-group-prepend">
    ...
    <div class="input-group flex-nowrap" style="width: 400px; margin-bottom: 10px">
        ...
        <input type="number" class="form-control" placeholder="Money" aria-label="Username" aria-describedby="addon-wrapping" name="money">
    </div>
    <button class="btn btn-primary" style="margin-top: 10px; color: white">ADD</button>
</form>
</body>
</html>
